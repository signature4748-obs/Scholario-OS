...
/**
 * SS-1 — Settings → Devices.
 *
 * Real session records from /api/auth/sessions (the Session table with
 * sign-in device context). Sessions created before device tracking
 * existed render honestly as "Unknown device". Two-step confirm for
 * "sign out all others" (matches the planner's armed-confirm pattern).
 */
