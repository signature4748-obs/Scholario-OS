 ...
 * SS-1 — Settings → About.
 *
 * Minimal and honest: product name, the workspace version (APP_VERSION
 * single source — same value the VersionGuard serves), the current
 * school and academic year from the server session. No marketing.
 */
    ...
    <SectionCard icon={Info} title="About" caption="Scholario on this device">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">Your school workspace</p>
        </div>
      </div>
      <div className="divide-y divide-border/60">
        <InfoRow label="Version" value={`v${APP_VERSION}`} />
        <InfoRow label="Workspace" value="Student" />
