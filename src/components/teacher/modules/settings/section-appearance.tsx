...
/**
 * TS-SETTINGS → Appearance.
 *
 * The application's theme system (Light / Dark / System + accent
 * colours). Device-local by design — rendering preferences belong to
 * the device that renders them.
 */
